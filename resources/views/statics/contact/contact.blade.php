        ...
        <div class="col-12 col-lg-6">
          <div class="row justify-content-xl-center">
            <div class="col-12 col-xl-11">
              ...
              <p class="lead fs-4 text-secondary mb-5">A Itechit tem tudo o que você precisa em soluções de digital e tecnologia. Acesse nosso canal de atendimento para obter mais informações.</p>
            ...
            <form action="{{ route('sendEmailContact') }}" method="POST">
              ...
              <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Digite seu nome e sobrenome">
                </div>
                <div class="col-12 col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="email@ydomain.com" required">
                  </div>
                </div>
                <div class="col-12 col-md-6">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="subject" name="subject" placeholder="nos informe o motivo do contato" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  <div class="d-grid">
                    <button class="btn  btn-lg" style="background-color: #4a57bf; color: white" type="submit">Enviar Mensagem</button>
                  </div>
                </div>
              </div>
            </form>
